...
<section class="container-fluid mr-auto ml-auto mt-auto mb-auto pt-2">
    ...
    <nav class="p-0 m-0" aria-label="breadcrumb">
        <ol class="breadcrumb bg-white p-0 mt-0 justify-content-end">
          ...
          <li class="breadcrumb-item active" aria-current="page"> Cartas</li>
        </ol>
    </nav>
    ...
    <div class="row justify-content-between">
        <div class="col-sm-6">
            <a class="card text-decoration-none mr-auto ml-auto" style="width: 18rem;" href="#">
                ...
                <div class="card-body">
                    <h5 class="card-title text-center">Consultar carta</h5>
        ...
        <div class="col-sm-6">
            <a class="card text-decoration-none mr-auto ml-auto" style="width: 18rem;" href="#">
                ...
                <div class="card-body">
                    <h5 class="card-title text-center">Administrar tipo de carta</h5>
                    <p class="card-text text-justify">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </a>
        </div>
    ...
    <div class="container mt-4">
        <p class="lead text-justify">Breve explicacion acerca de la opción de cartas....Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum ullam rerum, cumque recusandae reprehenderit dolor vitae est aliquam hic. Ipsam, officia laborum! Odio earum ducimus assumenda tenetur. Quibusdam, impedit laudantium!</p>
    </div>
